// ⚠️ نسخة طبق الأصل من docs/orderCredit.js
// المتجر يُنشر من مجلد almurad-store كجذر مستقل، فما يقدر يوصل
// للملف الأصلي. أي تعديل لازم ينصار بالملفين سوا — ماكو خطوة
// بناء تنسخه تلقائياً.
// ════════════════════════════════════════════════════════
